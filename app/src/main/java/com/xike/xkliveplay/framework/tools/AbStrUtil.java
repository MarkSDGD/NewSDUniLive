...
public class AbStrUtil
{
	...
	/**
	 * @Description: 数据大于10000的时候进行处理 ,显示格式如 19.99万<br>
	 */
	public static String getF10000(String f2)
	{
		String str = "";
		if (!isEmpty(f2))
		{
	...
	/**
	 * 
	 * @Title: getFileSizeStr <br>
	 * @author 白杰 <br>
	 * @Description: 将文件大小转换为相应的单位，如“B”，“KB”，“GB”，“TB” <br>
	 * @param @param size
	 * @param @return <br>
	 * @return String <br>
	 * @throws <br>
	...
	public static String getFileSizeStr(long fileSize)
	{
		...
		if (fileSize > 0)
		{
			...
			if (kiloByte < 1)
			{
				sFileSize = String.valueOf(fileSize);
				return sFileSize + "B";
			}
	 ...
	 * @Title: getF10000 <br>
	 * @author 白杰 <br>
	 * @Description: 数据大于10000的时候进行处理 <br>
	 * @param @param f1
	 * @return String <br>
	 * @throws <br>
	 */
	...
	/**
	  * getStringByLength(获得字符串指定的长度)
	  *
	  * @Title: getStringByLength
	  * @Description: TODO
	  *  @param val     ：传入的字符串
	  *  @param catLen  ： 汉字个数
	  * @return String  ：返回剪辑以后的字符串长度
	 */
	public static String getStringByLength(String val, int catLen)
	{
		float len = 0.0f;
		String catStr = val;
		for (int i = 0; i < val.length(); i++)
		{
			int length = val.codePointAt(i);
			...
			if (Math.floor(len) == catLen)
			{
				catStr = val.substring(0, i + 1);
			}if(len > catLen){
				break;
			}
		}
