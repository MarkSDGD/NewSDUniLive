...
/**
  * @ClassName: GDAuthAuthRes
  * @Description: TODO
  * @author Mernake
  * @date 2018年7月18日 上午11:18:01
  *
  */
public class GDAuthAuthRes extends GDAuthBase
{
	private GDAuthAuthData data = new GDAuthAuthData();
	
	
	/**
	 * @return the data
	 */
	public GDAuthAuthData getData() {
		return data;
	}
	 ...
	 */
	public void setData(GDAuthAuthData data) {
		this.data = data;
	}


	public class GDAuthAuthData {
	...
	@Override
	public String toString() {
		return "GDAuthAuthRes [toString()=" + super.toString() + "]";
	}
