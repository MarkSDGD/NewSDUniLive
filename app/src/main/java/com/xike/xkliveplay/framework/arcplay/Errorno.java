...
public class Errorno{	
    ...
    public static String getErrorInfo(int errID,int extra)
    {
    	String errStr = null;
    	...
    	switch (errID)
    	{
			...
			case Errorno.PLAYER_SEEK_OVERSPILL:
				...
				break;
			case IPlayerStateListener.PLAYER_CONNECT_FAIL:
				errStr = "Http connect failed.";
				break;
			case IPlayerStateListener.PLAYER_PREPARE_FAIL:
				errStr = "Prepare data fail.";
				break;
			default:
				errStr = "Unknow Error:what = " + errID + " and extra = 0x" + Integer.toHexString(extra);
				break;
    	}
    	return errStr;
    }
