...
public class MainUpView extends FrameLayout {
	...
	public void setFocusViewRoot(View newView, View oldView, float scale, View rootView) {
		setFocusView(newView, scale,rootView);
		setUnFocusView(oldView);
	}
	...
	public void setFocusView(View view, float scale, View rootView) {
		setFocusView(view, scale, scale,rootView);
	}
	...
	public void setFocusView(View view, float scaleX, float scaleY, View rootView) {
		if (this.mEffectBridge != null)
			this.mEffectBridge.onFocusViewRoot(view, scaleX, scaleY,rootView);
	}
	...
	public void setFocusWithChildren(View newView, View oldView, float scale, View innerView, float innerScale, float moveX, float moveY) {
		setFocusView(newView,scale);
		setUnFocusView(oldView);
		setFocusChildrenMove(innerView,innerScale,innerScale,moveX,moveY);
	}

	public void setFocusChildrenMove(View innerView, float innerScaleX, float innerScaleY, float moveX, float moveY) {
		if (this.mEffectBridge != null)
			this.mEffectBridge.setFocusChildrenMove(innerView,innerScaleX,innerScaleY,moveX,moveY);
	}

	public void setUnFocusChildrenMove(View innerView, float innerScale, float moveX, float moveY){
		if (this.mEffectBridge != null)
			this.mEffectBridge.setUnFocusChildrenMove(innerView,innerScale,innerScale,moveX,moveY);
	}
}
