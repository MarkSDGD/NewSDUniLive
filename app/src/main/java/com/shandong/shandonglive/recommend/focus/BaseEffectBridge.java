...
public abstract class BaseEffectBridge {
	 ...
	 *
	 */
	public abstract void onFocusViewRoot(View focusView, float scaleX, float scaleY, View rootView);
	...
	public void setUnFocusChildrenMove(View innerView, float innerScaleX, float innerScaleY, float moveX, float moveY){}
}
